...
namespace Chiligames.MetaAvatarsPun
{
    public class PlayerManager : MonoBehaviourPunCallbacks
    {
        ...
        private void Awake()
        {
            if (myAvatarEntity == null)
            {
                //Instantiate(myAvatarEntity);
        ...
        IEnumerator SpawnAvatar()
        {
            if (myAvatarEntity == null)
            {
                if (noOculusCredentials)
                {
                    ...
                    myAvatarEntity = PhotonNetwork.Instantiate(avatarTestPrefab.name, OVRCameraRig.transform.position,
                        OVRCameraRig.transform.rotation);
                }
                else
                {
                    ...
                    myAvatarEntity = PhotonNetwork.Instantiate(avatarPrefab.name, OVRCameraRig.transform.position,
                        OVRCameraRig.transform.rotation);
                }
                ...
                var voiceSetup = PhotonNetwork.Instantiate(photonVoiceSetupPrefab.name,
                ...
                myAvatarEntity.GetComponent<SampleAvatarEntity>()
                    .SetLipSync(voiceSetup.GetComponent<OvrAvatarLipSyncContext>());
        ...
        public void ChangeMyAvatar(string assetPath)
        {
            ...
            myAvatarEntity.GetComponent<SampleAvatarEntity>().LoadLoggedInUserCdnAvatar();
        }
        
        //Next scene and previous scene teleporting
        /*
